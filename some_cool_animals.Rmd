...
{.tabset} creates individual tabs for sections, recognizes lower order tabs as things to be tabbed ({.tabset} in 3rd order header, 4th order headers recognized as tabs). End tabs section with header of equal order than original {.tabset}
